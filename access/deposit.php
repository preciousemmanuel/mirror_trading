...
if(isset($_POST['editAmount'])){
  ...
  mysqli_query($db,"update deposit_histories set status='approved' where id=$id") or die(mysqli_error($db));
  ...
  //update accounts
    ...
    $q=mysqli_query($db,"update deposits set $column=$column+$crypto_amount,usd=usd+$amount where user_id=$user_id") or die(mysqli_error($db));
        ...
        <section id="main-content" class=" ">
            <div class="wrapper main-wrapper row" style=''>
                ...
                <div class='col-xs-12'>
                    ...
                    <div class="pull-left">
                        <!-- PAGE HEADING TAG - START -->
                        <h4 class="title boldy mb-5 mt-15">Deposit history</h4>
                        <!-- PAGE HEADING TAG - END -->
                    </div>
                                ...
                                <div class="col-xs-12">
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table vm trans table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                          $qr1=mysqli_query($db,"select t.*,u.email,u.name from deposit_histories t join users u on t.user_id=u.id order by id desc");
