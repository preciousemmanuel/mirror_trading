...
<head>
    ...
    <title>CFXMining - Register</title>
                            ...
                            <div id="login" class="login loginpage mt-0 no-pl no-pr pt30 pb30">    
                                ...
                                <div class="box login">
                                    ...
                                    <div class="content-body" style="padding-top:25px">
                                        ...
                                        <form id="msform" action="#" novalidate="novalidate" class="no-mb no-mt">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit" class="btn btn-primary mt-10 btn-corner right-15">Sign up</button>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@8"></script>
    ...
    e.preventDefault()
    var url="signup-auth.php?action=signup";
