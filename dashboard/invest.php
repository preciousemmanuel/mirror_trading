...
<head>
  ...
  <!-- Title -->
  <title>Invest - Mirror Trading</title>
          ...
          <div class="col-lg-12 col-md-12">
            <div class="card" id="button7">
              <div class="card-body">
                ...
                <p class="mg-b-20">Select Your Investment Type</p>
                <div class="text-wrap">
                  <div class="example">
                    <div class="btn-list">
                      <a href="trading-investment.php"  class="btn btn-primary btn-lg btn-block">Trading Investment</a>
                      <a href="mining-investment.php"  class="btn btn-success btn-lg btn-block">Mining Investment</a>
                    </div>
                  </div>
                </div>
              </div>
