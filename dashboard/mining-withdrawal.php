...
<head>
    ...
    <!-- Title -->
    <title>Mining Withdrawal - Mirror Trading</title>
                ...
                <div class="breadcrumb-header justify-content-between">
                    <div class="left-content">
                        ...
                        <div class="d-flex p-0">
                            ...
                            <p class="text-primary mb-0 hover-cursor">Mining Withdrawal</p>
                        </div>
                    </div>
                </div>
                <!-- /breadcrumb -->
                                        ...
                                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            ...
                                            <div style="overflow: auto;">
                                                <table class="table table-bordered ">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $qr1 = mysqli_query($db, "select * from withdraw_farming where user_id=" . $_SESSION['user_id'] . " order by id desc");
                                                        if ($qr1) {
...
$(document).on('keyup','#amount_to_send',function(e){
 ...
 $(document).on('submit','#form_ms',function(e){
    ...
    e.preventDefault()
    var url="../access/signup-auth.php?action=withdraw_farm";
     Swal.fire({
  title: 'Are you sure?',
