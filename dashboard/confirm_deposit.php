...
$qrx = mysqli_query($db, "select * from deposit_histories where id=$trans_id") or die(mysqli_error($db));
...
<head>
    ...
    <!-- Title -->
    <title>Confirm Investment - Mirror Trading</title>
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('submit', '#form_ms', function(e) {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                var url = "../access/signup-auth.php?action=confirm_deposit";
