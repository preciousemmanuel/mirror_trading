...
$queryEarnings=mysqli_query($db,"select * from earnings_farm where user_id=$id limit 1") or die(mysqli_error($db));
...
$queryDeposit=mysqli_query($db,"select * from deposits_farm where user_id=$id limit 1") or die(mysqli_error($db));
...
<head>
  ...
  <!-- Title -->
  <title>Mining - Mirror Trading</title>
        ...
        <div class="breadcrumb-header justify-content-between">
          <div class="left-content">
            ...
            <div class="d-flex p-0">
              ...
              <p class="text-primary mb-0 hover-cursor">Mining</p>
            </div>
          </div>
            ...
            <div class="card">
              <div class="card-body">
                <div class="clearfix">
                  ...
                  <div class="float-start">
                    <p class="mb-0 text-start">Total Mining Balance</p>
                    <div class="">
              ...
              <div class="card-body">
                <div class="btn-list btn-stretch">
                  ...
                  <a href="mining-investment.php" class="btn btn-outline-secondary stretch-grow">Invest</a>
                  <a href="mining-withdrawal.php" class="btn btn-outline-success stretch-grow">Withdraw</a>
                ...
                <div class="table-responsive market-values">
                  ...
                  >
                    ...
                    <?php
                      ...
                      $qr1=mysqli_query($db,"select * from deposit_farm_histories where user_id={$id}  order by id desc ");
