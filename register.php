...
<head>
  <meta charset="utf-8" />
  <title>Register - Mirror Trading</title>
  <!-- Stylesheets -->
        ...
        <div class="login-content__inner">
          <div class="logo-box">
            <div class="logo text-center">
              <a href="index.html" title="Mirror Trading - Digital Assets Investment Platform"><img src="images/logo-dark.png" width="134" id="dLogo" class="main-logo" alt="Logo Dark" /></a>
            </div>
          </div>
          <form action="#" id="msform">
            <div class="row">
              ...
              <!-- /.col-md-12 -->
              <div class="col-md-12">
                <input type="text" required name="email" placeholder="Enter Email Address *" />
              </div>
              <!-- /.col-md-12 -->
              <div class="col-md-12">
